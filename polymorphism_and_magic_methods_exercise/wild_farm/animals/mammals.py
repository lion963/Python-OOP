from polymorphism_and_magic_methods_exercise.wild_farm.animals.animal import Mammal
from polymorphism_and_magic_methods_exercise.wild_farm.food import Vegetable, Fruit, Meat, Seed, Food
